        ...
        <div class="alert flex flex-row items-center bg-red-200 p-5 rounded border-b-2 border-red-300 my-5 mb-4">
            ...
            <div class="alert-content ml-4">
              ...
              <div class="alert-description text-sm text-red-600">
                <span>Recuerde que contactaremos a la brevedad con usted al número <b>{{isset($usuario->telefono)?$usuario->telefono:'959484113'}}</b>.</span><br>
                <span>De no atender, nos comunicaremos al correo <b>{{$usuario->email}}</b>.</span>
              </div>
          </div>
        </div>
